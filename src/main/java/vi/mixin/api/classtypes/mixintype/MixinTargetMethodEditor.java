...
public class MixinTargetMethodEditor extends TargetMethodEditor {
    ...
    public InsnList getCaptureLocalsInsnList(int atIndex, String targetClassName) {
        ...
        try {
            ...
            int argumentCount = Type.getArgumentCount(targetMethodNode.desc);
